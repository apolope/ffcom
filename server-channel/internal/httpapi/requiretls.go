...
// sem proxy na frente, fluxo já descrito em server-channel/.env.example) a
...
// ligar a flag.
//
// /healthz fica isento — o HEALTHCHECK do Docker chama
// http://127.0.0.1:8080/healthz de dentro do próprio container, sem passar
// pelo proxy.
